...
(function ($) {
    ...
    function drawPopUp(target) {
        $('.popup-box').show();
        $('.blackout').show();
        $('html,body').css('overflow', 'hidden');
        popupData = target.getAttribute('data-date');
    };
    ...
    ;(function (defaults, $, window, document) {
        ...
        months: ["January", "February", "March", "April", "May", "June", "Julн", "August", "September", "October", "November", "December"],
        shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Ags", "Sep", "Oct", "Nov", "Dic"],
        date: (new Date()),
...
for(i = 0; i < 500; i++) {
    ...
    data.push({ title: names[c1 % names.length], start: new Date(y, m, d, h, m), end: end, allDay: !(i % 6), text: ""  });
}
